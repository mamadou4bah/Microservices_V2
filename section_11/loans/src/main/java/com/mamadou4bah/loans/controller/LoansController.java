...
import com.mamadou4bah.loans.dto.ErrorResponseDto;
import com.mamadou4bah.loans.dto.ResponseDto;
...
public class LoansController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoanDetails(@RequestHeader("mamadou4bah-correlation-id") String correlationId,
